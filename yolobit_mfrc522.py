...
class MFRC522:
    ...
    def __init__(self, spi=None, gpioRst=None, gpioCs=None):
        if gpioRst is not None:
            ...
            self.rst = None
        # TODO fails without cableSelect
        ...
        if spi is not None:
            ...
            if uname()[0] == 'WiPy':
                ...
                self.spi.init(SPI.MASTER, baudrate=1000000,
                              pins=(sck, mosi, miso))
            # TODO update to match https://github.com/cefn/avatap/blob/master/python/host/cockle.py #prepareHost()
            elif uname()[0] == 'esp8266':
                self.spi = SPI(baudrate=100000, polarity=0,
